...
In order to support loading of multiple wallets in paynay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is paynay.cpp.
...
Changes to paynay.cpp
----------------------
paynay.cpp is the entry point into paynay-qt, and as such, will require some minor modifications to provide hooks for
