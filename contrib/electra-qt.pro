...
RESOURCES += src/qt/paynay.qrc src/qt/paynay_locale.qrc

TRANSLATIONS += src/qt/locale/paynay_bg.ts \
                src/qt/locale/paynay_de.ts \
                src/qt/locale/paynay_en.ts \
                src/qt/locale/paynay_es.ts \
                src/qt/locale/paynay_fi.ts \
                src/qt/locale/paynay_fr.ts \
                src/qt/locale/paynay_it.ts \
                src/qt/locale/paynay_ja.ts \
                src/qt/locale/paynay_pl.ts \
                src/qt/locale/paynay_pt.ts \
                src/qt/locale/paynay_ru.ts \
                src/qt/locale/paynay_sk.ts \
                src/qt/locale/paynay_sv.ts \
                src/qt/locale/paynay_vi.ts \
                src/qt/locale/paynay_zh_CN.ts \
                src/qt/locale/paynay_zh_TW.ts
