Contributing to paynay Core
============================

The paynay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the paynay Core project, and is not to be
confused with overall paynay Network Protocol consensus changes.

Whether a pull request is merged into paynay Core rests with the project merge
...
Patches that change paynay consensus rules are considerably more involved than
...
Where a patch set proposes to change the paynay consensus, it must have been
...
The project leader is the release manager for each paynay Core release.
