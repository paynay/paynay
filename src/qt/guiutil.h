...
/** Utility functions used by the paynay Qt UI.
 */
namespace GUIUtil
{
...
// Render paynay addresses in monospace font
...
// Parse "paynay:" URI into recipient object, return true on successful parsing
