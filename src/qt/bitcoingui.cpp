                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("paynay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&paynay Project"), this);
    webmainAction->setStatusTip(tr("paynay Project Website"));
    ...
    facebookAction->setStatusTip(tr("paynay Facebook"));
    ...
    twitterAction->setStatusTip(tr("paynay Twitter"));
    ...
    discordAction->setStatusTip(tr("paynay Discord"));
    ...
    youtubeAction->setStatusTip(tr("paynay Youtube"));
    ...
    telegramAction->setStatusTip(tr("paynay Telegram"));
    ...
    redditAction->setStatusTip(tr("paynay Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap paynay"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell paynay Coin (PAYNAY)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    paynayBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&paynay block explorer"), this);
    paynayBlockExplorerAction->setStatusTip(tr("paynay blockchain explorer"));
    paynayBlockExplorerAction->setToolTip(paynayBlockExplorerAction->statusTip());
    paynayBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&paynay Project Github"), this);
    githubAction->setStatusTip(tr("paynay Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a paynay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and paynay: URIs)"));
...
//    }
    ...
    connect(paynayBlockExplorerAction, SIGNAL(triggered()), this, SLOT(paynayBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About paynay Core"), this);
    aboutAction->setStatusTip(tr("Show information about paynay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for paynay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your paynay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified paynay addresses"));
    ...
    openAction->setStatusTip(tr("Open a paynay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the paynay Core help message to get a list with possible paynay command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(paynayBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("paynay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to paynay network", "", count));
}
...
{
    QString strTitle = tr("paynay Core"); // default title
