...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case PAYNAY:
        return QString("paynay");
    case mECA:
        return QString("mpaynay");
    case uECA:
        return QString::fromUtf8("upaynay");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case PAYNAY:
            return QString("PAYNAY");
        case mECA:
            return QString("Milli-PAYNAY (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-PAYNAY (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
