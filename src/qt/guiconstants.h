...
/* paynay GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "paynay"
#define QAPP_ORG_DOMAIN "paynayproject.org"
#define QAPP_APP_NAME_DEFAULT "paynay-Qt"
#define QAPP_APP_NAME_TESTNET "paynay-Qt-testnet"
