...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PAYNAY);
    ...
    if (!settings.contains("nAnonymizepaynayAmount"))
        settings.setValue("nAnonymizepaynayAmount", 1000);

    nAnonymizepaynayAmount = settings.value("nAnonymizepaynayAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizepaynayAmount"))
        SoftSetArg("-anonymizepaynayamount", settings.value("nAnonymizepaynayAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in paynay.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizepaynayAmount:
            return QVariant(nAnonymizepaynayAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizepaynayAmount:
            nAnonymizepaynayAmount = value.toInt();
            settings.setValue("nAnonymizepaynayAmount", nAnonymizepaynayAmount);
            emit anonymizepaynayAmountChanged(nAnonymizepaynayAmount);
            break;
        case CoinControlFeatures:
