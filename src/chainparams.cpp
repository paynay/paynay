...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "paynay is born";
...
/* while (true) {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x3f1efc1da019644a3805450f25477fa40c29b10e35a25385ea3738555b095520"));
        assert(hashGenesisBlock == uint256("0x00000eab21f62fe8980094aff6570cadbe717ab3b1afda482abe352550980ac6"));

     
		
		vSeeds.push_back(CDNSSeedData("1", "161.35.189.61"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x3f1efc1da019644a3805450f25477fa40c29b10e35a25385ea3738555b095520"));
        assert(hashGenesisBlock == uint256("0x000017a2e13f36da24625fdde4de4b9d8cb0d5191b29b024ab7d45e51e66eff1"));
...
//207fffff
        ...
        assert(genesis.hashMerkleRoot == uint256("0x3f1efc1da019644a3805450f25477fa40c29b10e35a25385ea3738555b095520"));
        assert(hashGenesisBlock == uint256("0x43b456da0baa5c4c5774ea1a90dd4fbc8e56d5c00c15e0e167a8111f65becdfb"));
