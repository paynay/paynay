...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* paynay features */
        {"paynay", "masternode", &masternode, true, true, false},
        {"paynay", "listmasternodes", &listmasternodes, true, true, false},
        {"paynay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"paynay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"paynay", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"paynay", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"paynay", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"paynay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"paynay", "masternodedebug", &masternodedebug, true, true, false},
        {"paynay", "startmasternode", &startmasternode, true, true, false},
        {"paynay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"paynay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"paynay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"paynay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"paynay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"paynay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"paynay", "mnbudget", &mnbudget, true, true, false},
        {"paynay", "preparebudget", &preparebudget, true, true, false},
        {"paynay", "submitbudget", &submitbudget, true, true, false},
        {"paynay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"paynay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"paynay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"paynay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"paynay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"paynay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"paynay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"paynay", "checkbudgets", &checkbudgets, true, true, false},
        {"paynay", "mnsync", &mnsync, true, true, false},
        {"paynay", "spork", &spork, true, true, false},
        {"paynay", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> paynay-cli " + methodname + " " + args + "\n";
}
